    ...
    <div>
      <nav>
        <ul>
            ...
            <li><Link to="/registercourses">Courses Registration</Link></li>
            <li><Link to="/viewcontent">View Content</Link></li>

            <li><Link to="/viewassessment">View Assessment</Link></li>

            {/* <li><Link to="/viewstudentmappedcourses">Registered Courses</Link></li> */}

            <li><Link to="/uploadassessment">Upload Assessment</Link></li>
