  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
        <label>Year</label>
          <input type="text" id="year"  value={formData.year} onChange={handleChange} placeholder='Enter Year' required />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="text" id="coursecode" value={formData.coursecode} onChange={handleChange} placeholder='Enter Your Course Code' required /> 
        </div>
        <div>
          <label>Course name</label>
          <input type="text" id="coursename"  value={formData.coursename} onChange={handleChange} placeholder='Enter Your Course Name' required />
        </div>
